// Generated by gencpp from file offb/Waypoint.msg
// DO NOT EDIT!


#ifndef OFFB_MESSAGE_WAYPOINT_H
#define OFFB_MESSAGE_WAYPOINT_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::offb::Waypoint_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::offb::Waypoint_<ContainerAllocator> const> ConstPtr;

}; // struct Waypoint_

typedef ::offb::Waypoint_<std::allocator<void> > Waypoint;

typedef boost::shared_ptr< ::offb::Waypoint > WaypointPtr;
typedef boost::shared_ptr< ::offb::Waypoint const> WaypointConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::offb::Waypoint_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::offb::Waypoint_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::offb::Waypoint_<ContainerAllocator1> & lhs, const ::offb::Waypoint_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::offb::Waypoint_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::offb::Waypoint_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::offb::Waypoint_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::offb::Waypoint_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::offb::Waypoint_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::offb::Waypoint_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::offb::Waypoint_<ContainerAllocator> >
{
  ...
  static const char* value(const ::offb::Waypoint_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x7a0d2b53dcd6b7afULL;
  static const uint64_t static_value2 = 0xf0aa748703e85e92ULL;
};

template<class ContainerAllocator>
struct DataType< ::offb::Waypoint_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::offb::Waypoint_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Waypoint.msg\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::offb::Waypoint_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::offb::Waypoint_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::offb::Waypoint_<ContainerAllocator>& v)
  {
    s << indent << "frame: ";
