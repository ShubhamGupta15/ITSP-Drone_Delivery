...
(cl:defmethod cl:initialize-instance :after ((m <Waypoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Waypoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name offb-msg:<Waypoint> is deprecated: use offb-msg:Waypoint instead.")))

(cl:ensure-generic-function 'frame-val :lambda-list '(m))
(cl:defmethod frame-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb-msg:frame-val is deprecated.  Use offb-msg:frame instead.")
  (frame m))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb-msg:command-val is deprecated.  Use offb-msg:command instead.")
  (command m))

(cl:ensure-generic-function 'is_current-val :lambda-list '(m))
(cl:defmethod is_current-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb-msg:is_current-val is deprecated.  Use offb-msg:is_current instead.")
  (is_current m))

(cl:ensure-generic-function 'autocontinue-val :lambda-list '(m))
(cl:defmethod autocontinue-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb-msg:autocontinue-val is deprecated.  Use offb-msg:autocontinue instead.")
  (autocontinue m))

(cl:ensure-generic-function 'param1-val :lambda-list '(m))
(cl:defmethod param1-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb-msg:param1-val is deprecated.  Use offb-msg:param1 instead.")
  (param1 m))

(cl:ensure-generic-function 'param2-val :lambda-list '(m))
(cl:defmethod param2-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb-msg:param2-val is deprecated.  Use offb-msg:param2 instead.")
  (param2 m))

(cl:ensure-generic-function 'param3-val :lambda-list '(m))
(cl:defmethod param3-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb-msg:param3-val is deprecated.  Use offb-msg:param3 instead.")
  (param3 m))

(cl:ensure-generic-function 'param4-val :lambda-list '(m))
(cl:defmethod param4-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb-msg:param4-val is deprecated.  Use offb-msg:param4 instead.")
  (param4 m))

(cl:ensure-generic-function 'x_lat-val :lambda-list '(m))
(cl:defmethod x_lat-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb-msg:x_lat-val is deprecated.  Use offb-msg:x_lat instead.")
  (x_lat m))

(cl:ensure-generic-function 'y_long-val :lambda-list '(m))
(cl:defmethod y_long-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb-msg:y_long-val is deprecated.  Use offb-msg:y_long instead.")
  (y_long m))

(cl:ensure-generic-function 'z_alt-val :lambda-list '(m))
(cl:defmethod z_alt-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb-msg:z_alt-val is deprecated.  Use offb-msg:z_alt instead.")
  (z_alt m))
