...
class Web_InputRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type Web_InputRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type Web_InputRequest
    let len;
    let data = new Web_InputRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Web_InputRequest(null);
...
class Web_InputResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type Web_InputResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type Web_InputResponse
    let len;
    let data = new Web_InputResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Web_InputResponse(null);
...
module.exports = {
  Request: Web_InputRequest,
  Response: Web_InputResponse,
  md5sum() { return '93721527c216f57d672506df413f1fd8'; },
  datatype() { return 'offb/Web_Input'; }
};
