...
int main(int argc, char **argv)
{
    ...
    //offb::Data hostel_ID;
    std_msgs::String hostel_ID;

    ros::Publisher hostel_data_pub1 = p1.advertise<std_msgs::String>("UAV1_Data", 100);
    ros::Publisher hostel_data_pub2 = p2.advertise<std_msgs::String>("UAV2_Data", 100);

   // while(hostel_data_pub1.getNumSubscribers() == 0 && hostel_data_pub2.getNumSubscribers() == 0){
   //     //ros::spinOnce();
   //     rate.sleep();
   //     ROS_INFO("WAITING...");
   // }
