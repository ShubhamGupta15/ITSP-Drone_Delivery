...
std::vector<mavros_msgs::Waypoint> waypoint_in(std::string hostel)
{
    ...
    mavros_msgs::Waypoint wp_msg[5];
        ...
        if (hostel == "Hostel 5"){
            ...
            wp_msg[5].param3 = 0;
            wp_msg[5].param4 = 0;
            wp_msg[5].x_lat = 19.13398597233391;
            wp_msg[5].y_long = 72.91314691725862;
            wp_msg[5].z_alt = 10.0;
            ...
            wp_msg[6].param3 = 0;
            wp_msg[6].param4 = 0;
            wp_msg[6].x_lat = 19.131931872621035;
            wp_msg[6].y_long = 72.915175289366;
            wp_msg[6].z_alt = 10.0;
            ...
            wp_msg[7].param3 = 0;
            wp_msg[7].param4 = 0;
            wp_msg[7].x_lat = 19.12871289;
            wp_msg[7].y_long = 72.91537415;
            wp_msg[7].z_alt = 10.0;
            ...
            wp_msg[8].param3 = 0;
            wp_msg[8].param4 = 0;
            wp_msg[8].x_lat = 19.12579446;
            wp_msg[8].y_long = 72.91619611;
            wp_msg[8].z_alt = 10.0;
